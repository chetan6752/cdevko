...
type Summary = { title: String; data: any; icon?: any; tooltip?: string; info?: any; subData?: React.ReactNode };

export default function SummaryCard({ title, data, icon: Icon, tooltip = '', info: Info, subData }: Summary) {
