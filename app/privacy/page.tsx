	...
	return (
		<div className="relative min-h-screen bg-gradient-to-br from-sky-100 via-white to-sky-50 pl-2 pr-2 leading-relaxed text-zinc-800">
			...
			<div className="m-4 mt-4 max-w-3xl pt-3 sm:m-4 sm:mt-8 lg:m-auto">
				...
				<p className="mt-2">
					Author built the <b>FinTracker</b> web application as a <b>Freemium app</b>. This SERVICE is provided by at
				...
				<p className="mt-2">
					...
					accessible at FinTracker unless otherwise defined in this Privacy Policy.
				</p>
			</div>
			...
			<div className="relative m-4 mb-10 mt-3 max-w-3xl pt-3 sm:m-4 sm:mb-10 lg:m-auto lg:mb-10">
				...
				<p className="mt-2">
					...
					<a className="border-b-[1px] border-black pb-[1px]" href="mailto:hello@fintracker.com">
