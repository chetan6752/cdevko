...
export const emails = {
	...
	account: {
		deleted: 'Your FinTracker account is Deleted!',
	},
	welcome: {
	...
	from: 'DevKo Finance <team@mayurbadgujar.me>',
	signin: { subject: 'Sign in link for FinTracker' },
	signup: { subject: 'Sign up link for FinTracker' },
};
